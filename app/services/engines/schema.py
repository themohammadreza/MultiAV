"""
Compatibility shim for legacy imports and engine containers.

Tries to import the shared normalizer from ``app.services.aggregator.normalize``;
if that fails (e.g., in stripped-down engine containers), it falls back to a
local copy of the same helpers.
"""

try:
    from app.services.aggregator.normalize import (  # type: ignore
        ENGINE_STATUSES,
        SEVERITY_LEVELS,
        SEVERITY_SCORES,
        VERDICTS,
